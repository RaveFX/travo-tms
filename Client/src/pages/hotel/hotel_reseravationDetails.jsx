    ...
    <div className="flex h-screen ">
      ...
      <div className="flex flex-col w-full bg-[#FFFFFF] bg-opacity-20 ">
        ...
        <div className="flex justify-between">
          <h1 className=" font-poppins font-extrabold mt-4 mx-5 text-[#2C2738]">
            Reservations
          </h1>
        </div>
          ...
          <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
              <div className="overflow-hidden">
                <h1 className=" font-poppins font-extrabold mx-5 text-[#2C2738] text-sm">
                  Today
                </h1>
                ...
                <h1 className=" font-poppins font-extrabold mx-5 mt-6 text-[#2C2738] text-sm">
                  07/08/2023
                </h1>
                <table className="min-w-full text-left text-sm font-light">
                  <thead className="border-b font-medium dark:border-neutral-500 text-[#B7BBB8]">
