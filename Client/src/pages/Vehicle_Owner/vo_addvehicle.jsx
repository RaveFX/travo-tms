...
function MyApp() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8080/api/v1/vehicle/addVehicle', formData, {
                headers: {
                ...
                <div className="mb-5 overflow-y-auto">
                    <div className="w-full bg-white px-10">
                        ...
                        <p role="contentinfo" className=" focus:outline-nonetext-sm font-light leading-tight text-gray-600 mt-4">
                            Fill in the data for add new vehicle. It will take a couple of minutes. <br />
                        </p>
                        <div className="flex">
                                ...
                                <div className="w-1/2">
                                    <div className="mt-8 md:flex items-center">
                                        <div className="flex flex-col">
                                            ...
                                            <input name="VehicleModel" id="VehicleModel" type="VehicleModel" tabIndex={0} aria-label="Enter first name" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
                                    ...
                                    <div className="mt-12 md:flex items-center">
                                        <div className="flex flex-col">
                                            <label className="mb-3 text-sm leading-none text-gray-800">License No.</label>
                                            <input name="LicenseNo" id="LicenseNo" type="LicenseNo"  tabIndex={0}  className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
                                ...
                                <div>
                                    <div className="mt-8 md:flex items-center ">
                                        <div className="flex flex-col">
                                            ...
                                            <input name="Passengers" id="Passengers" type="Passengers" tabIndex={0}  className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
                                        <div className="flex flex-col md:ml-12 md:mt-0 mt-8">
                                            ...
                                            <div className=" flex items-center">
                                                <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700  flex flex-shrink-0 justify-center items-center relative">
                                                    <div className="bg-whiteborder rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                                                        <input name="AC" id="AC" type="checkbox" tabIndex={0}  defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" />
                                    ...
                                    <div className="mt-12 md:flex items-center">
                                        <div className="flex flex-col">
                                            ...
                                            <div className=" flex items-center">
                                                <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700  flex flex-shrink-0 justify-center items-center relative">
                                                    {/* <input id="" type="checkbox" tabIndex={0} aria-label="Yes" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" /> */}
                                                    <div className="bg-whiteborder rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                                                        <input name="BT" id="BT" type="checkbox" tabIndex={0} aria-label="I agree with the terms of service" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" />
                                                        <div className="check-icon hidden bg-green text-white rounded-sm">
                                                            <svg className="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                                <path d="M5 12l5 5l10 -10" />
                                                ...
                                                <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700  flex flex-shrink-0 justify-center items-center relative">
                                                    {/* <input type="checkbox" tabIndex={0} aria-label="Yes" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" /> */}
                                                    <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                                                        <input name="Sunroof" id="Sunroof" type="checkbox" tabIndex={0} aria-label="I agree with the terms of service" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" />
                                                        <div className="check-icon hidden bg-green text-white rounded-sm">
                                                            <svg className="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                                <path d="M5 12l5 5l10 -10" />
                                                ...
                                                <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700  flex flex-shrink-0 justify-center items-center relative">
                                                    {/* <input type="checkbox" tabIndex={0} aria-label="Yes" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" /> */}
                                                    <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                                                        <input name="WiFi" id="WiFi" type="checkbox" tabIndex={0} aria-label="I agree with the terms of service" defaultChecked className="checkbox opacity-0 absolute cursor-pointer w-full h-full" />
                                                        <div className="check-icon hidden bg-green text-white rounded-sm">
                                                            <svg className="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                                <path d="M5 12l5 5l10 -10" />
                                ...
                                <div className="w-1/2">
                                    <div className="mt-8 md:flex items-center ">
                                        <div className="flex flex-col">
                                            ...
                                            <input name="Rate" id="Rate" type="Rate" tabIndex={0} className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
                                        <div className="flex flex-col md:ml-12 md:mt-0 mt-8">
                                            <label className="mb-3 text-sm leading-none text-gray-800">Location</label>
                                            <input name="Location" id="Location" type="Location" tabIndex={0} aria-label="Enter last name" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
                                    </div>
                                    <div className="mt-12 md:flex items-center">
                                        <div className="flex flex-col">
                                            <label className="mb-3 text-sm leading-none text-gray-800">Image</label>
                                            <input name="Image" id="Image" type="text" tabIndex={0}  className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                        </div>
