    ...
    useEffect(() => {
      const fetchAttractions = async () => {
        try {
          ...
          const response = await axios.get('http://localhost:8080/api/v1/places/places-in-kandy');
      ...
      <div className="flex h-screen  ">
        ...
        <div className="flex flex-col w-full bg-[#D9D9D9] bg-opacity-20 z-[10000] ">
          ...
          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
            <h1 className="text-3xl font-poppins font-extrabold text-[#2AB57D] mb-6 mt-4">Attractions in Kandy Sri Lanka</h1>
...
export default AttractionsKandy