  ...
  const filteredTransactions =
    activeTab === "all"
      ...
      : transactionData.filter((transaction) =>
          transaction.name.toLowerCase().includes(activeTab.toLowerCase())
        );
      ...
      <div className="flex flex-col w-full bg-[#D9D9D9] bg-opacity-20 mb-4">
        ...
        >
          <div className="flex flex-col justify-between">
            {/* Add your page-specific button or elements here */}
        ...
        {/* Add your transaction details here based on the selected tab */}
      </div>
    </div>
  );
};
