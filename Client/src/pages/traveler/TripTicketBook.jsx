...
function App() {
    ...
    const agentId = decodeURIComponent(splitURL[7]);
    const eventId = decodeURIComponent(splitURL[8]);
        ...
        for (const count of counts) {
            ...
            if (ticket.length > 0) {
                try {
                    ...
                    await axios.post(
                        `http://localhost:8080/api/v1/traveler/tripActivityBooking/${userID}/${tripId}/${agentId}/${eventId}`, {
