...
import { logoW, logoB, close, leftarrow, menu, dashboard, request, invitation, star, message, user, settings } from '../Travel_guide/assets'

const Sidebar = () => {
  const [toggle, setToggle] = useState(false);
  const [open, setOpen] = useState(true);
  const menus = [
    { title: "Dashboard", src: dashboard,route:"/guide_dashboard",current:true },
