...
//     const inputMessages = [{ text: inputMessage, sender: 'user' }, ...messages];
//     setMessages(inputMessages);
//     setInputMessage('');

//     const message = {
//       content: inputMessage,
//       // You can add more message properties as needed
//     };
...
//       try {
//         const response = await fetch('/api/v1/trips/${tripId}/group-messages', {
//           method: 'POST',
//           headers: {
