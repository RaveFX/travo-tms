...
export function DayTabs() {
  ...
  return (
    <>
      <Tabs value="1" className="max-w-[40rem] m-8 mb-0 bg-transparent">
        <TabsHeader
        ...
        >
          {data.map(({ label, value }) => (
            <Tab key={value} value={value} onClick={() => handleOpen(value)}>
              {label}
            </Tab>
          ))}
        </TabsHeader>
        ...
        <Accordion open={open === "1"} icon={<Icon id={"1"} open={open} />}>
          ...
          <AccordionBody>
            ...
            <div className="flex flex-col justify-center gap-4 mt-8 mb-8">
              <Typography className="w-[20%] ml-[38%] opacity-[50%]">
                You haven't add item yet
              </Typography>
              <Button className="w-[10%] ml-[40%] text-[#57CC99] rounded-full bg-gray-300 normal-case shadow-none focus:shadow-none hover:shadow-none hover:bg-[#57CC99] hover:text-white active:shadow-none">
                Add item
              </Button>
            </div>
