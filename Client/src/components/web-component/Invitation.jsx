...
export function SubscriptionPopover() {
  ...
  const link = `http://127.0.0.1:5173/travo/text/${id}/${uniqueLink}`;
          ...
          <div className="absolute top-12 right-0 mt-2 p-4 bg-white rounded-lg shadow-md">
            ...
            <MenuItem>
              <div className="flex gap-2 mt-4">
                <a
                  href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`Check out this link: http://127.0.0.1:5173/travo/text/${id}/${uniqueLink}`)}`}
                  target="_blank"
