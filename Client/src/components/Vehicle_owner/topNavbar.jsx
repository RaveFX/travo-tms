...
// import SearchBar from '../../components/Vehicle_owner/searchbar';
import SearchBar from '../../components/Vehicle_owner/searchbar';
import { Link } from 'react-router-dom';
import { people01 } from '../../assets/Vehicle_Owner'
            ...
            <div>
                <div className="flex space-x-4">
                    <div className='flex flex-row justify-items-center gap-[10px]'>
                        <img src="../public/Vehicle_owner/notification.svg" alt="Logo" className="" />
                        <Link to={path}>
                        <img src={people01} 
