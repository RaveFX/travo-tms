...
function chunk(array, size3, guard) {
  if (guard ? isIterateeCall_default(array, size3, guard) : size3 === void 0) {
    ...
    size3 = nativeMax(toInteger_default(size3), 0);
  }
  ...
  while (index < length) {
    result[resIndex++] = baseSlice_default(array, index, index += size3);
  }
  return result;
}
...
function style2(node, property2) {
  var css = "";
  var transforms = "";
  if (typeof property2 === "string") {
    return node.style.getPropertyValue(hyphenateStyleName2(property2)) || getComputedStyle3(node).getPropertyValue(hyphenateStyleName2(property2));
  }
  Object.keys(property2).forEach(function(key) {
    var value = property2[key];
    if (!value && value !== 0) {
...
function matches2(node, selector) {
  if (!matchesImpl2) {
    var body = document.body;
    var nativeMatch = body.matches || body.matchesSelector || body.webkitMatchesSelector || body.mozMatchesSelector || body.msMatchesSelector;
    matchesImpl2 = function matchesImpl3(n, s) {
      return nativeMatch.call(n, s);
    };
  }
...
function baseRange(start2, end2, step, fromRight) {
  var index = -1, length = nativeMax3(nativeCeil2((end2 - start2) / (step || 1)), 0), result = Array(length);
  while (length--) {
  ...
  _createClass(EventCell2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement(EventWrapper, Object.assign({}, this.props, {
        ...
        tabIndex: 0,
        style: _objectSpread2(_objectSpread2({}, userProps.style), style3),
...
function noOverlap(_ref) {
  ...
  for (var _i6 = 0; _i6 < styledEvents.length; ++_i6) {
    ...
    size3 = 100 / (maxIdx + 1);
    styledEvents[_i6].size = size3;
    for (var _j6 = 0; _j6 < allFriends.length; ++_j6)
      allFriends[_j6].size = size3;
  }
...
var DayColumn = function(_React$Component) {
  ...
  _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max3), className = _dayProp.className, style3 = _dayProp.style;
