...
export default function HomePage() {
  return (
    ...
    >
      ...
      <Button
        disabled
        className="drop-shadow-lg p-2 pl-5 pr-5  bg-rose-700 font-poppins ml-10 mb-10 font-bold text-2xl text-white"
      >
      ...
      <Button
        disabled
        className="drop-shadow-lg p-2 mt-10 pl-5 pr-5  bg-rose-700 font-poppins ml-10 mb-10 font-bold text-2xl text-white"
      >
