  ...
  return (
    <div>
      <footer class="bg-white" aria-labelledby="footer-heading">
        ...
        <div class="px-5 mt-10 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
        ...
        <div class="px-5 py-12 mx-auto bg-gray-50  sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
