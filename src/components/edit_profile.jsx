...
const edit_profile = ({ name, email, location }) => {
    return (
                    ...
                    <div className=''>
                        ...
                        <div className="mt-6 flex-col ">
                            ...
                            <div className='flex flex-row mt-2'>
                                ...
                                <div className="flex flex-col">
                                    <label className="mb-3 text-sm leading-none text-gray-800">Phone</label>
                                    <input type tabIndex={0} aria-label="Enter date of birth" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                </div>
                            </div>
                            <div className='flex flex-row mt-2'>
                                ...
                                <div className='my-10 mx-8'>
                                    <button type="button" class="text-green bg-gray-300 hover:bg-black rounded-full  focus:ring-green font-medium text-sm px-5 
                                    py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><Link to="/vehicle_owner_dashboard">Save</Link></button>
                    ...
                    <div className=''>
                        ...
                        <div className="mt-6 flex-col ">
                            <div className=' flex flex-col'>
                                ...
                                <div className="flex flex-col  pr-2">
                                    <label className="mb-3 text-sm leading-none text-gray-800">Current Password</label>
                                    <input type tabIndex={0} aria-label="Enter date of birth" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                </div>
                                <div className="flex flex-col">
                                    <label className="mb-3 text-sm leading-none text-gray-800">New Password</label>
                                    <input type tabIndex={0} aria-label="Enter date of birth" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                </div>
                            </div>
                            ...
                            <div className='flex flex-row mt-2'>
                                ...
                                <div className="flex flex-col  pr-2">
                                    <label className="mb-3 text-sm leading-none text-gray-800">Retype Password</label>
                                    <input type tabIndex={0} aria-label="Enter date of birth" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
                                </div>
                                <div className="flex flex-col  pr-2">
                                    {/* <label className="mb-3 text-sm leading-none text-gray-800">Location</label>
