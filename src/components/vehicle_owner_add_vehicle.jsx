                            ...
                            <div className="w-1/2">
                                <div className="mt-8 md:flex items-center">
                                    ...
                                    <div className="flex flex-col md:ml-12 md:mt-0 mt-8">
                                        <label className="mb-3 text-sm leading-none text-gray-800">Year of Manufacture</label>
                                ...
                                <div className="mt-12 md:flex items-center">
                                    <div className="flex flex-col">
                                        <label className="mb-3 text-sm leading-none text-gray-800">Vehicle's Color</label>
