...
import {
  ...
  export default function Sidebar(props) {
    ...
    const navList = [
      {icon : <RectangleGroupIcon className="h-5 w-5" />, name : "Dashboard", link : "/traveler_dashboard"},
      {icon : <MapIcon className="h-5 w-5" />, name : "My Trips", link : "/mytrips",subItems: [
        { icon: <ClipboardDocumentIcon className="h-5 w-5" />, name: "Itinerary", link: "/itinerary",state:1 },
