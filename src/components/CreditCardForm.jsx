...
const CreditCardForm = () => {
    ...
    return (
        <div className="m-4">
            ...
            <div className="credit-card w-1/2 sm:w-auto shadow-lg mx-auto rounded-xl bg-white">
        ...
        <header class="flex flex-col justify-center items-center">
          ...
          >
            <img class="w-2/4 h-2/4 p-4 mx-auto" src="https://media.istockphoto.com/id/530649463/photo/premium-membership-gold-badge.webp?b=1&s=170667a&w=0&k=20&c=o1EgjBY9-EPhyOroPO1MhpyyyFoIp1c1V2taf-YJbV8=" alt="" />
