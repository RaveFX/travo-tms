      ...
      <nav class="  bg-transparent  z-20 top-0 w-screen h-15 left-0  ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2">
            <Link
              type="button"
              class="text-white  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-indigo-800 dark:hover:bg-indigo-950 dark:focus:ring-blue-800" to="/signin"
            >
              Get started
            </Link>
            <button
