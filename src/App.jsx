...
import Activity_Schedule from "./pages/activity_agent/Activity_Agent_Schedule";
import Activity_ScheduleDetails from "./pages/activity_agent/Activity_Agent_Schedule_Details";
import Activity_ReviewsDetails from "./pages/activity_agent/Reviews_Details";
import Activity_Profile from "./pages/activity_agent/Profile";
import Activity_Edit_Profile from "./pages/activity_agent/Edit_Profile";
import Activity_AddActivity from "./pages/activity_agent/Add_Activity";
import Activity_Dashboard from "./pages/activity_agent/Dashboard";
import Activity_ImageGrid from "./pages/activity_agent/Activity";
...
export default function App() {
  return (
    ...
    <Route path='/guide_dashboard' element={<Travel_Guide_Dashboard/>}> </Route>
  ...
  <Route exact path="/activity_dashboard" element={<Activity_Dashboard />} />
  <Route exact path="/activity_schedule" element={<Activity_Schedule />} />
  <Route exact path="/activity_schedule/details" element={<Activity_ScheduleDetails />} />
  <Route exact path="/activity_reviews" element={<Activity_ReviewsDetails />} />
  <Route exact path="/activity_profile" element={<Activity_Profile />} />
  <Route exact path="/activity_profile/edit_profile" element={<Activity_Edit_Profile/>} />
  <Route exact path="/activity_activities" element={<Activity_ImageGrid />} />
  <Route exact path="/activity_activities/add_activity" element={<Activity_AddActivity />} />
  ...
  <Route exact path="/home" element={<HomePage />} />
          ...
          <Route path="/traveler_dashboard" element={<Dashboard />} />
